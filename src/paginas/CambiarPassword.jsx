...
const CambiarPassword = () => {
  ...
  return (
    <>
        <AdminNav />
        <h2 className="font-black text-3xl text-center mot-10">Cambiar Password</h2>
        <p className="text-xl mt-5 mb-10 text-center">Modifica tu {""}
            <span className="font-bold text-indigo-600">Password aquí</span>
        </p>
        ...
        <div className="flex justify-center">
            ...
            { msg && <Alerta 
                ...
                >
                    ...
                    <div className="my-3">
                        <label className="uppercase text-gray-600 font-bold">Password Nuevo</label>
                        <input 
                        type="password" 
                        className="boder bg-gray-50 w-full mt-5 p-2 rounded-lg"
                        name="pwd_nuevo" 
